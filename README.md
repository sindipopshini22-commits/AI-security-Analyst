...
✍️ Text-based phishing detection
🎨 Clean and modern user interface
📌 Structured and easy-to-understand results
🧠 How It Works
The user inputs a URL or suspicious text
The system extracts key security signals such as:
HTTPS usage
Suspicious keywords
Domain structure
